#ifndef _ZD_INVITE_HANDLER_H_
#define _ZD_INVITE_HANDLER_H_
...
class CZDInviteHandler : public CZDEventHandler
{
public:
	CZDInviteHandler();
	virtual ~CZDInviteHandler();

	virtual bool OnReceive(pjsip_rx_data* rdata) override;
};

#endif // _ZD_INVITE_HANDLER_H_
