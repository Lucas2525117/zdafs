#ifndef _ZD_SIP_MEDIA_H_
#define _ZD_SIP_MEDIA_H_
...
{
public:
	ZDSipDialog(pjsip_dialog* dialog)
		: m_dialog(dialog)
		, m_handle(nullptr)
	{
	}
...
public:
	// 单例---c++11之后线程安全
	static CZDSipMedia& GetInstance()
	{
		static CZDSipMedia media;
		return media;
	}
...
private:
	...
	std::unordered_map<std::string, std::shared_ptr<ZDSipDialog>> m_dialogs;
