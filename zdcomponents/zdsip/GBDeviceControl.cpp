...
int CGBDeviceControl::PTZControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	return 0;
}

int CGBDeviceControl::TeleRebootControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (deviceID.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, teleBootInfo);
}

int CGBDeviceControl::RecordControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	return 0;
}

int CGBDeviceControl::GuardControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, guardInfo);
}

int CGBDeviceControl::AlarmResetControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, alarmResetInfo);
}

int CGBDeviceControl::IFrameControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, iframeInfo);
}

int CGBDeviceControl::DragZoomInControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, dragZoomInInfo);
}

int CGBDeviceControl::DragZoomOutControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, dragZoomOutInfo);
}

int CGBDeviceControl::HomePositionControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, homePositionInfo);
}

// TODO
int CGBDeviceControl::PTZPreciseControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, ptzPreciseInfo);
}

int CGBDeviceControl::DeviceUpgradeControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, deviceUpgradeInfo);
}

int CGBDeviceControl::FormatSDCardControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, formatSDCardInfo);
}

int CGBDeviceControl::TargetTrackControl_(CZDGBDevice* device, const std::string& deviceID, const std::string& request)
{
	if (!device || deviceID.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, targetTrackInfo);
}
