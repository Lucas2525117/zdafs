...
CZDXmlParser::CZDXmlParser(std::string url)
{
	std::string str;
...
CZDXmlParser::~CZDXmlParser()
{
}

char* CZDXmlParser::UnicodeToGB2312(const char* src)
{
...
char* CZDXmlParser::GB2312ToUnicode(const char* src, int len)
{
...
std::string CZDXmlParser::StrReplace(std::string str, const std::string& from, const std::string& to)
{
	std::stringstream ss;
	size_t start_pos = 0;
