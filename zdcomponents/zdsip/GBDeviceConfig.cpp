...
int CGBDeviceConfig::BaseParamConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::SVACEncodeConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::SVACDecodeConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::VideoParamPropertyConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::RecordPlanConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::AlarmRecordConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::PictureMaskConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::FrameMirrorConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::AlarmReportConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	return 0;
}

int CGBDeviceConfig::OSDConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, osdInfo);
}

int CGBDeviceConfig::SnapShotConfig_(CZDGBDevice* device, const std::string& gbid, const std::string& request)
{
	if (!device || gbid.empty() || request.empty())
		return -1;
	...
	return CZDSipContext::GetInstance().SendSipMessage(device, snapShotInfo);
}
